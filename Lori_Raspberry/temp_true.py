...
if __name__ == "__main__":
	...
	sensor = MyPublisher("MyPublisher_temp")#,'192.168.1.6')
	#sensor.start()
	#print("True temperature sensor on Raspberry started (room 1)")
